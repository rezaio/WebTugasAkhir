                              ...
                              <div class="col-md-8">
                                    ...
                                    <div class="col-6 mb-3">
                                        <div class="form-group">
                                            <label for="name">Jabatan</label>
                                                <div class="form-group">
                                                    <select name="jabatan" class="form-control" id="basicSelect">
                                    ...
                                    <div class="col-6 mb-3">
                                        <div class="form-group">
                                            <label for="name">Role</label>
                                                <div class="form-group">
                                                    <select name="role" class="form-control" id="basicSelect">
                                ...
                                <class class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <button class="btn btn-primary" href ="<?= base_url(); ?>tambahuser"></button>
                                        </div>
                                    </div>
                                    </div>
                                 </class>
